...
import { ArrowRight, Shield, Users, MapPin, Sparkles, Phone, MessageCircle, Clock } from 'lucide-react';
...
export default function WelcomePage() {
  ...
  const handleWhatsApp = () => {
    window.open('https://wa.me/919535238661?text=Hi%20MaahiCabs,%20I%20want%20to%20book%20a%20ride', '_blank');
  };

  const handleCall = () => {
    window.open('tel:+919535238661', '_blank');
  };
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-maahi-brand via-[#3B3FA8] to-maahi-accent opacity-95">
        ...
        <div className="absolute top-1/4 right-1/4 w-48 h-48 bg-maahi-warn/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-2 sm:space-y-3 flex-shrink-0">
          ...
          <div className="text-center space-y-1 px-4 sm:px-6 md:px-8">
            ...
            <div className="flex items-center justify-center gap-1.5 sm:gap-2 text-white/90">
              ...
              <p className="text-xs sm:text-sm md:text-base font-medium">Safe & Reliable</p>
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4" />
            </div>
          </div>
        </div>
        ...
        <div className="text-center space-y-1 max-w-2xl flex-shrink-0 mb-4 sm:mb-6 md:mb-8 px-4 sm:px-6 md:px-8">
          ...
          <p className="text-xs sm:text-sm text-white/80">
            Founded by <span className="font-semibold text-white">Maahi Narender</span>
          </p>
        </div>

        {/* Features Grid - 4 Square Cards - Compact */}
        <div className="w-full grid grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-2 md:gap-2.5 px-4 sm:px-4 md:px-4 max-w-[280px] sm:max-w-[320px] md:max-w-md flex-shrink-0">
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-2 sm:p-2 md:p-2 aspect-square border border-white/20 shadow-md hover:bg-white/15 transition-all flex flex-col items-center justify-center text-center">
            <div className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-maahi-brand/20 rounded-lg flex items-center justify-center mb-1">
              <Shield className="w-5 h-5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white drop-shadow-none" />
            </div>
            <h3 className="text-[9px] sm:text-[10px] md:text-xs font-bold text-white mb-0.5">Safe & Secure</h3>
            <p className="text-[8px] sm:text-[9px] text-white/80 leading-tight">Verified partners</p>
          </div>

          <div className="bg-white/10 backdrop-blur-md rounded-lg p-2 sm:p-2 md:p-2 aspect-square border border-white/20 shadow-md hover:bg-white/15 transition-all flex flex-col items-center justify-center text-center">
            <div className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-maahi-accent/20 rounded-lg flex items-center justify-center mb-1">
              <Users className="w-5 h-5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white drop-shadow-none" />
            </div>
            <h3 className="text-[9px] sm:text-[10px] md:text-xs font-bold text-white mb-0.5">By Women</h3>
            <p className="text-[8px] sm:text-[9px] text-white/80 leading-tight">For Women</p>
          </div>

          <div className="bg-white/10 backdrop-blur-md rounded-lg p-2 sm:p-2 md:p-2 aspect-square border border-white/20 shadow-md hover:bg-white/15 transition-all flex flex-col items-center justify-center text-center">
            <div className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-maahi-warn/20 rounded-lg flex items-center justify-center mb-1">
              <Clock className="w-5 h-5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white drop-shadow-none" />
            </div>
            <h3 className="text-[9px] sm:text-[10px] md:text-xs font-bold text-white mb-0.5">24/7 Available</h3>
            <p className="text-[8px] sm:text-[9px] text-white/80 leading-tight">Anytime booking</p>
          </div>

          <div className="bg-white/10 backdrop-blur-md rounded-lg p-2 sm:p-2 md:p-2 aspect-square border border-white/20 shadow-md hover:bg-white/15 transition-all flex flex-col items-center justify-center text-center">
            <div className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-maahi-accent/20 rounded-lg flex items-center justify-center mb-1">
              <MapPin className="w-5 h-5 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white drop-shadow-none" />
            </div>
            <h3 className="text-[9px] sm:text-[10px] md:text-xs font-bold text-white mb-0.5">Bengaluru</h3>
            <p className="text-[8px] sm:text-[9px] text-white/80 leading-tight">City-wide service</p>
          </div>
        </div>
        ...
        <div className="w-full max-w-md px-2 sm:px-4 space-y-2 sm:space-y-3 flex-shrink-0 mt-4 sm:mt-6 md:mt-8">
          <button
            ...
            className="w-full bg-white text-maahi-brand font-bold py-3 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl shadow-2xl flex items-center justify-center gap-2 hover:bg-white/95 active:scale-[0.98] transition-all text-sm sm:text-base md:text-lg min-h-[48px] sm:min-h-[52px] md:min-h-[56px] group"
          >
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            <button
              ...
              className="bg-maahi-accent text-white font-semibold py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl shadow-lg flex items-center justify-center gap-1.5 sm:gap-2 hover:bg-[#00968A] active:scale-[0.98] transition-all text-xs sm:text-sm md:text-base min-h-[44px] sm:min-h-[48px]"
            >
            ...
            <button
              onClick={handleCall}
              className="bg-maahi-warn text-white font-semibold py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl shadow-lg flex items-center justify-center gap-1.5 sm:gap-2 hover:bg-[#E6B000] active:scale-[0.98] transition-all text-xs sm:text-sm md:text-base min-h-[44px] sm:min-h-[48px]"
            >
